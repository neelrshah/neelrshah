...
<h3 align="center">Senior Software Engineer at Expleo | Ex-Persistent Systems | React Native | Python | Flutter | Mobile App Developer</h3>   
...
* **2x Top Talent** (FY24 & FY25) at Persistent Systems.
* **Performance:** Reduced API calls by **40%** and load times by **30%** via advanced caching strategies.
* **Impact:** Migrated **5M+ users** from Azure B2C to Firebase with zero downtime.
* **Innovation:** Integrated **14+ AI tools** into educational platforms to reduce instructor workload by 40%.
...
![GenAI](https://img.shields.io/badge/GenAI-Integration-7948db?style=flat)
